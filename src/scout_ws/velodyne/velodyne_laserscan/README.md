...
* `use_sensor_data_qos` (bool) - If True, use sensor-data QoS (best effort) for subscribing to `velodyne_points` and publishing `scan`. If False, use default QoS depth 10 (reliable). Defaults to False.
