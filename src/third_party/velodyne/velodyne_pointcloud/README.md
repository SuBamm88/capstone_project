...
* `use_sensor_data_qos` (bool) - If True, use sensor-data QoS (best effort) for both subscription to `velodyne_packets` and publication of `velodyne_points`. If False, use default QoS depth 10 (reliable). Defaults to False.
